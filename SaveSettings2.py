...
s = \
[
    ['Sample', 'tango://set/sample/voltage/voltage_r', True],
    ['Extr', 'tango://ktof/logic/lens1/Ext_VURead', True],
    ['Foc', 'tango://ktof/logic/lens1/Foc_VURead', True],
    ['Z1', 'tango://ktof/logic/lens1/Z1_VURead', True],
    ['Z2', 'tango://ktof/logic/lens1/Z2_VURead', True],
    ['A', 'tango://ktof/logic/lens1/A_VURead', True],
    ['B', 'tango://ktof/logic/lens1/B_VURead', True],
    ['C', 'tango://ktof/logic/lens1/C_VURead', True],
    ['D', 'tango://ktof/logic/lens1/D_VURead', True],
    ['E', 'tango://ktof/logic/lens1/E_VURead', True],
    ['F', 'tango://ktof/logic/lens1/F_VURead', True],
    ...
    #downstream
    ['H', 'tango://ktof/logic/lens1/H_VURead', True],
    ['I', 'tango://ktof/logic/lens1/I_VURead', True],
    ['J', 'tango://ktof/logic/lens1/J_VURead', True],
    ['K', 'tango://ktof/logic/lens1/K_VURead', True],
    ['L', 'tango://ktof/logic/lens1/L_VURead', True],
    ['M', 'tango://ktof/logic/lens1/M_VURead', True],
    ['N', 'tango://ktof/logic/lens1/N_VURead', True],
    #screen    
    ['1', 'tango://ktof/logic/lens1/1_VURead', False],
    ['Screen', 'tango://ktof/logic/lens1/Screen_VURead', False],
    #DLD
    ['MCPb', 'tango://ktof/logic/lens1/MCPb_VURead', False]
]
